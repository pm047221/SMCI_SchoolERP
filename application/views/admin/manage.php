                                    ...
                                    <form role="form" action="<?php echo site_url('franchise/search') ?>" method="post" class="">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group"> 
                                                <label><?php echo $this->lang->line('franchise_nm'); ?></label> <small class="req"> *</small> 
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    <form role="form" action="<?php echo site_url('franchise/search') ?>" method="post" class="">
                                        ...
                                        <input type="text" name="search_text" class="form-control" value="<?php  echo set_value('search_text'); ?>"   placeholder="<?php echo $this->lang->line('search_by_frachise_keyword'); ?>">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
