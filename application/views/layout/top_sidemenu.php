<ul class="sessionul fixedmenu">
    ...
    <li class="dropdown">
        ...
        <ul class="dropdown-menu verticalmenu" style="min-width:194px;font-size:10pt;left:3px;">
            ...
            <?php } if ($this->rbac->hasPrivilege('manage_franchise', 'can_view')) { ?>

                <li role="presentation"><a style="color:#282828; font-family: 'Roboto-Bold';padding:6px 20px;" role="menuitem" tabindex="-1" href="<?php echo base_url(); ?>admin/franchise/manage"><i class="fa fa-users"></i><?php echo $this->lang->line('manage_franchise'); ?></a></li>

            <?php } if ($this->rbac->hasPrivilege('manage_day_care', 'can_view')) { ?>

                <li role="presentation"><a style="color:#282828; font-family: 'Roboto-Bold';padding:6px 20px;" role="menuitem" tabindex="-1" href="<?php echo base_url(); ?>admin/daycare/manage"><i class="fa fa-child"></i><?php echo $this->lang->line('manage_day_care'); ?></a></li>
