<aside class="main-sidebar" id="alert2">
    ...
    <section class="sidebar" id="sibe-box">
        ...
        <ul class="sidebar-menu verttop">
            ...
            if ($this->module_lib->hasActive('franchise')) {
                if (($this->rbac->hasPrivilege('franchise', 'can_view') ||
                        $this->rbac->hasPrivilege('register_franchise', 'can_view') ||
                        $this->rbac->hasPrivilege('manage_franchise', 'can_view'))) {
                    ?>

                    <li class="treeview <?php echo set_Topmenu('Franchise'); ?>">
                        <a href="#">
                            <i class="fa fa-users ftlayer"></i> <span><?php echo $this->lang->line('franchise'); ?></span> <i class="fa fa-angle-left pull-right"></i>
                        </a>
                        <ul class="treeview-menu">
                            <?php
                            if ($this->rbac->hasPrivilege('register_franchise', 'can_add')) {
                                ?>
                                <li class="<?php echo set_Submenu('franchise/create'); ?>"><a href="<?php echo base_url(); ?>admin/franchise/create"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('register_franchise'); ?></a></li>
                                
                                <?php
                            }
                            if ($this->rbac->hasPrivilege('manage_franchise', 'can_view')) {
                                ?>
                                <li class="<?php echo set_Submenu('franchise/manage'); ?>"><a href="<?php echo base_url(); ?>admin/franchise/manage"><i class="fa fa-angle-double-right"></i><?php echo $this->lang->line('manage_franchise'); ?></a></li>
                            <?php } ?>
                        </ul>
                    </li>
                    <?php
            ...
            if ($this->module_lib->hasActive('day_care')) {
                if (($this->rbac->hasPrivilege('day_care', 'can_view') ||
                        $this->rbac->hasPrivilege('register_day_care', 'can_view') ||
                        $this->rbac->hasPrivilege('manage_day_care', 'can_view'))) {
                    ?>

                    <li class="treeview <?php echo set_Topmenu('day_care'); ?>">
                        <a href="#">
                            <i class="fa fa-child ftlayer"></i> <span><?php echo $this->lang->line('day_care'); ?></span> <i class="fa fa-angle-left pull-right"></i>
                        </a>
                        <ul class="treeview-menu">
                            <?php
                            if ($this->rbac->hasPrivilege('register_day_care', 'can_view')) {
                                ?>
                                <li class="<?php echo set_Submenu('daycare/create'); ?>"><a href="<?php echo base_url(); ?>admin/daycare/create"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('register_day_care'); ?></a></li>
                                
                                <?php
                            }
                            if ($this->rbac->hasPrivilege('manage_day_care', 'can_view')) {
                                ?>
                                <li class="<?php echo set_Submenu('daycare/manage'); ?>"><a href="<?php echo base_url(); ?>admin/daycare/manage"><i class="fa fa-angle-double-right"></i><?php echo $this->lang->line('manage_day_care'); ?></a></li>
                            <?php } ?>
                        </ul>
                    </li>
                    <?php
